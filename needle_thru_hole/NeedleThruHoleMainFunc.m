...
function [ output_args ] = NeedleThruHoleMainFunc()
    ...
    needle_tip_pos_init.position = [-20;20;0]; % the initial need tip position wrt spatial frame
    ...
    % goal configuration
    needle_tip_pose_goal.position = [40;20;0];
    ...
    STEP_SIZE = 1;
    %% execute RRT
    [ tree ] = RRT( needle_tip_pos_init, needle_tip_pose_goal, MAX_NODE, MAX_ITER, STEP_SIZE);
